    ...
    createGrid = () => {
        return this.state.array.map((item, index) => {
            ...
            if (index === 0 || item.roundType !== this.state.array[index - 1].roundType)
                round = <div className="blockName1"><Typography component={'span'} className="blockText" align="left"
                                                                variant="body1">
            ...
            if (item.roundType === "final") {
                ...
                if (item.player !== "")
                    final = false;
                return (
                    <div key={index} className="blockTable1">
                        <div className="blockName"><Typography component={'span'} className="blockText" align="left"
                                                               variant="body1">
                            Победитель
                        </Typography>
                        </div>
                ...
                if (item.player1 !== "" && item.player2 !== "" && this.state.array[this.state.array.length - 1].player === "")
                    button = false;
                return <div key={index} className="blockTable1">
                    {round}
                    <div>
                        <TableContainer className="table" component={Paper}>
